...
switch (platform) {
	case "android":
		...
		localFileExisted = existsSync(
			join(__dirname, "rsonl-db.android-arm64.node"),
		);
		try {
			if (localFileExisted) {
	...
	case "win32":
		switch (arch) {
			case "x64":
				localFileExisted = existsSync(
					join(__dirname, "rsonl-db.win32-x64-msvc.node"),
				);
				try {
					if (localFileExisted) {
			...
			case "ia32":
				localFileExisted = existsSync(
					join(__dirname, "rsonl-db.win32-ia32-msvc.node"),
				);
				try {
					if (localFileExisted) {
			...
			case "arm64":
				localFileExisted = existsSync(
					join(__dirname, "rsonl-db.win32-arm64-msvc.node"),
				);
				try {
					if (localFileExisted) {
	...
	case "darwin":
		switch (arch) {
			case "x64":
				localFileExisted = existsSync(
					join(__dirname, "rsonl-db.darwin-x64.node"),
				);
				try {
					if (localFileExisted) {
			...
			case "arm64":
				localFileExisted = existsSync(
					join(__dirname, "rsonl-db.darwin-arm64.node"),
				);
				try {
					if (localFileExisted) {
	...
	case "freebsd":
		...
		localFileExisted = existsSync(
			join(__dirname, "rsonl-db.freebsd-x64.node"),
		);
		try {
			if (localFileExisted) {
	...
	case "linux":
		switch (arch) {
			case "x64":
				...
				if (isMusl) {
					localFileExisted = existsSync(
						join(__dirname, "rsonl-db.linux-x64-musl.node"),
					);
					try {
						if (localFileExisted) {
					...
					localFileExisted = existsSync(
						join(__dirname, "rsonl-db.linux-x64-gnu.node"),
					);
					try {
						if (localFileExisted) {
			...
			case "arm64":
				...
				if (isMusl) {
					localFileExisted = existsSync(
						join(__dirname, "rsonl-db.linux-arm64-musl.node"),
					);
					try {
						if (localFileExisted) {
					...
					localFileExisted = existsSync(
						join(__dirname, "rsonl-db.linux-arm64-gnu.node"),
					);
					try {
						if (localFileExisted) {
			...
			case "arm":
				localFileExisted = existsSync(
					join(__dirname, "rsonl-db.linux-arm-gnueabihf.node"),
				);
				try {
					if (localFileExisted) {
